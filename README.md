...
## Environments
- Preview: https://main--sausaxen-itc-flf--aemysites.aem.page/
- Live: https://main--sausaxen-itc-flf--aemysites.aem.live/
- Block Library: https://main--sausaxen-itc-flf--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `sausaxen-itc-flf` directory in your favorite IDE and start coding :)
